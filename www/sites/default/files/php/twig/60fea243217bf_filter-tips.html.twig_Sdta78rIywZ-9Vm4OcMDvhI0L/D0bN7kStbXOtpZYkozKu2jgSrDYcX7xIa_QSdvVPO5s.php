...
class __TwigTemplate_fe0e316b9f17db76f781f6fcb5cd8000ecbf876aab7c623d3d37730c829e40be extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-" . twig_replace_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 45), 45, $this->source), ["/" => "-"]))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "core/themes/seven/templates/classy/content-edit/filter-tips.html.twig", "/var/www/thebuildingprojects.com/www/core/themes/seven/templates/classy/content-edit/filter-tips.html.twig");
    }
